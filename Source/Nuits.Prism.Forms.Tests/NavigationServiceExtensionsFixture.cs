...
namespace Nuits.Prism.Forms.Tests
{
    public class NavigationServiceExtensionsFixture
    {
        ...
        public void NavigateAsyncBySingleNavigation()
        {
            ...
            var navigation = new Navigation<TestPageViewModel>();
            ...
            Assert.Equal(task, navigationService.Object.NavigateAsync(new Navigation[] {navigation}));
        ...
        public void NavigateAsyncByDeepLink()
        {
            ...
            var firstNavigation = new Navigation<TestPageViewModel>();
            firstNavigation.Parameters["key1"] = "value1";
            var secondNavigation = new Navigation<SecondPageViewModel>();
        ...
        public void NavigateAsyncByDeepLinkWithParams()
        {
            ...
            Assert.Equal(task, navigationService.Object.NavigateAsync(new Navigation[] { firstNavigation, secondNavigation }, true, false));

        }

        public void Test(bool? useModalNavigation = null, bool animated = true, params Navigation[] navigations)
        {
